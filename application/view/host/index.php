<div class="container">
    <div class="row">
        ...
        <div class="form-group">
            <label for="locaitons-input">Location</label>
            <input type="text" class="form-control" id="location-input" required placeholder="Enter the event location">
        </div>
        <div class="form-group">
            <label for="max-guests-input">Slots count</label>
            <input type="number" class="form-control" id="max-guests-input" required placeholder="Enter maximum number of attenders you want to have">
        </div>
        <div class="form-group">
            <label for="desc-input">Additional info</label>
            <textarea class="form-control" id="desc-input" rows="3"></textarea>
        </div>
